            ...
            {filteredBookings.length === 0 ? (
              ...
              filteredBookings.map((booking) => (
                <div
                  ...
                  style={{ backgroundColor: "white", borderRadius: 12, padding: 20, border: `2px solid ${getStatusColor(booking.status)}`, cursor: "pointer", transition: "all 0.2s", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}
                ...
                >
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                    <h3 style={{ margin: 0, fontSize: 18, color: "#0F172A" }}>{booking.name}</h3>
                    <span style={{ backgroundColor: getStatusColor(booking.status), color: "white", padding: "4px 12px", borderRadius: 20, fontSize: 12, fontWeight: 600, textTransform: "capitalize" }}>
                      {booking.status}
                    </span>
                  </div>
